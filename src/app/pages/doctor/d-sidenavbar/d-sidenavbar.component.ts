...
@Component({
  selector: 'app-d-sidenavbar',
  imports: [CommonModule,RouterModule],
  templateUrl: './d-sidenavbar.component.html',
  styleUrl: './d-sidenavbar.component.css'
})
export class DSidenavbarComponent implements OnInit {
