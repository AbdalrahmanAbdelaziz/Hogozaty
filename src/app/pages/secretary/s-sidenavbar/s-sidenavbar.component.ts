...
@Component({
  selector: 'app-s-sidenavbar',
  imports: [CommonModule,RouterModule],
  templateUrl: './s-sidenavbar.component.html',
  styleUrl: './s-sidenavbar.component.css'
})
export class SSidenavbarComponent implements OnInit {
